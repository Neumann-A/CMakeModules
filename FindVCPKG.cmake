...
function(vcpkg_get_triplet_path triplet outpath)
    macro(vcpkg_find_triplet tripbasepath intrip)
        string(REGEX_REPLACE [[\\(\\)?]] [\\] tripbasepath "${tripbasepath}")
...
function(DEDUCE_VCPKG_CRT_LINKAGE)
    ...
    set(z_vcpkg_possible_triplet_locations "${VCPKG_OVERLAY_TRIPLETS}")
    list(APPEND z_vcpkg_possible_triplet_locations "${VCPKG_TRIPLET_PATH}")
    list(TRANSFORM z_vcpkg_possible_triplet_locations APPEND "/${VCPKG_TARGET_TRIPLET}.cmake")
    message(STATUS "Searching for vcpkg triplet '${VCPKG_TARGET_TRIPLET}' at '${z_vcpkg_possible_triplet_locations}' !")
    foreach(_file_location IN LISTS z_vcpkg_possible_triplet_locations)
        message(STATUS "Searching in '${_file_location}'!")
        if(EXISTS "${_file_location}")
            message(STATUS "Found vcpkg triplet at '${_file_location}'!")
            include("${_file_location}")
            if(VCPKG_CRT_LINKAGE STREQUAL "static" AND WIN32)
...
if(NOT VCPKG_MANIFEST_DIR AND EXISTS "${CMAKE_SOURCE_DIR}/vcpkg_manifest")
    set(VCPKG_MANIFEST_DIR "${CMAKE_SOURCE_DIR}/vcpkg_manifest")
endif()